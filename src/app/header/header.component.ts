...
@Component({
  ...
  template: `
        ...
        <li><a routerLink="unsubscribe-strategies">Évitez les fuites de mémoire avec des stratégies de unsubscribe</a></li>
        <li><a routerLink="higher-order-operators">Passez d'un Observable à un autre avec les opérateurs haut niveau</a></li>
			</ul>
		</div>
  `,
})
